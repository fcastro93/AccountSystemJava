...
<%
    ...
    try {
        ...
        System.out.println("3 Error: " + e.toString());
    }
                    ...
                    <div id="menu_container">
                        <ul class="sf-menu" id="nav">
                            ...
                            <li><a style="background-color:lightgrey" href="#">Flujo</a>
                                <ul>
                                    <li><a style="background-color:lightgrey" href="ingresos.jsp">Ingresos</a></li>
                ...
                <div class="content" style="padding: 14px 0 0 50px;">
                    ...
                    <div class="form_settings">
                        ...
                        <form action="GestorLogica" method="post">
                            <input class="submit" type="submit" name="btnIngresoPanel" value="Agregar" />

                            <br><br>

                            <input class="submit" type="submit" name="btnModEntrada" value="Modificar" />

                            <input class="submit" type="submit" name="invisibleIngreso" hidden="true" value="Buscar" />
                            ...
                            <div id="main-wrap" style="width: 1000px">
                                <div id="sidebar">  
                                    ...
                                    <label>
                                        <span>Desde: &nbsp;&nbsp;</span>
                                        <input class="myDate" type="text" name="txtIngresoDesde"/>
                                    ...
                                    <label>
                                        <span>Desde: &nbsp;&nbsp;</span>
                                        <input class="myDate" type="text" value="<%=desde%>" name="txtIngresoDesde"/>
                                    ...
                                    <label>
                                        ...
                                        %>
                                        <select id="id" name="cmbFiltroCuentaIngreso">
                                            ...
                                            <%                                                int totalColonesReales = 0;
                                                ...
                                                try {
                                                    ...
                                                    if (!desde.equals("vacio")) {
                                                        ...
                                                        statement = connection.prepareCall("{call mostrarIngresosRealesFiltro(?,?,?,?)}");
                                                        ...
                                                        statement = connection.prepareCall("{call mostrarIngresosReales(?)}");
                                                        statement.setString(1, razon);
                                                    }
...
%>
                                                ...
                                                <!--<td><a title="Modificar"><img width="15" height="15" src="images/edit.png" onclick="modificarFlujo(this)"/></a> </td>-->
                                            </tr>
                                            <% }
                                ...
                                <label>
                                    <span>Hasta: &nbsp;&nbsp;</span>
                                    <input class="myDate" type="text" name="txtIngresoHasta"/>
                                    <br/><br/>
                                </label>
                                <input class="submit" type="submit" name="btnIngresoFechaB"  value="Buscar"/>
                                <%
                                } else {
                                %>
                                <label>
                                    <span>Hasta: &nbsp;&nbsp;</span>
                                    <input class="myDate" type="text" value="<%=hasta%>" name="txtIngresoHasta"/>
                                    <br/><br/>
                                </label>
                                            ...
                                            <table style="width:100%; border-spacing:0;">
                                                ...
                                                <%                                                    try {
                                                        ...
                                                        /*if (!desde.equals("vacio")) {
                                                            DateFormat formatter = new SimpleDateFormat("MM/dd/yy");
                                                            date = formatter.parse(desde.toString());
                                                            statement = connection.prepareCall("{call mostrarIngresosEstimadosFiltro(?,?,?)}");
                                                            statement.setString(1, razon);
                                                        ...
                                                        statement = connection.prepareCall("{call mostrarIngresosEstimados(?)}");
                                                        statement.setString(1, razon);
                                                        //}
                                                        boolean hadResults = statement.execute();
                                                        ResultSet resultset = statement.getResultSet();
...
%>
                                                ...
                                                <% }
                                                    ...
                                                    System.out.println("2 Error: " + e.toString());
                                                %>
                                                <%                                }
                                                %>
